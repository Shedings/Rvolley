...
public class MultipartEntity implements HttpEntity {
    ...
    public MultipartEntity(String chartSet) {
        this.mBoundary = generateBoundary();
        this.DEFAULTCHARSET = chartSet;
    }
     ...
     * @param value
     */
    public void addStringPart(final String paramName, final String value) throws AuthFailureError {
     ...
     * @param fileName
     */
    private void writeToOutputStream(String paramName, byte[] rawData, String type,byte[] encodingBytes,String fileName) throws AuthFailureError {
        try {
            writeFirstBoundary();
            mOutputStream.write((CONTENT_TYPE + type + DEFAULTCHARSET + NEW_LINE_STR).getBytes());
            ...
            throw new AuthFailureError("writeToOutputStream IOException");
        }
    }
     ...
     * @param rawData
     */
    public void addBinaryPart(String paramName, final byte[] rawData,String fileName) throws AuthFailureError {
     ...
     * @param file
     */
    public void addFilePart(final String key, final File file) throws AuthFailureError {
        InputStream inputStream = null;
        try {
            inputStream = new FileInputStream(file);
            writeFirstBoundary();//添加提交表单头;
            final String type = CONTENT_TYPE + TYPE_OCTET_STREAM + DEFAULTCHARSET + NEW_LINE_STR;
            ...
            throw new AuthFailureError("addFilePart IOException");
        } finally {
    ...
    private byte[] getContentDispositionBytes(String paramName, String fileName) {
        ...
        if (!TextUtils.isEmpty(fileName)) {  // 文本参数没有filename参数,设置为空即可
